...
#define G 16384.0 // g scale 2
//#define G 8192.0 // g scale 4
//#define G 4096.0 // g scale 8
//#define G 2048.0 // g scale 16
...
// --- gyro init    
  ...
  for (i=0;i<leg_max;i++) leg_Z_offset[i]=0;
...
void set_leg_Z_offset(float pitch, float roll) {
  float pitch_dZ,roll_dZ;
  int i;

  pitch_dZ = tanf(pitch)*bl/2;
  roll_dZ = tanf(roll)*bw/2;
  
  leg_Z_offset[0]=pitch_dZ+roll_dZ;
  leg_Z_offset[1]=pitch_dZ-roll_dZ; 
  leg_Z_offset[2]=-pitch_dZ+roll_dZ; 
  leg_Z_offset[3]=-pitch_dZ-roll_dZ;  

  for (i=0;i<leg_max;i++) move_IK_leg(i,high_speed);
